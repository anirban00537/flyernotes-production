...
const index = () => {
  return (
    <div>
      <div>
        <header className="astro-X3CF2X7U">
          <nav className="z-10 w-full absolute astro-X3CF2X7U">
            <div className="max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
              <div className="flex flex-wrap items-center justify-between py-2 gap-6 md:py-4 md:gap-0 relative astro-X3CF2X7U">
                <input
                  aria-hidden="true"
                  type="checkbox"
                  name="toggle_nav"
                  id="toggle_nav"
                  className="hidden peer astro-X3CF2X7U"
                />
                <div className="relative z-20 w-full flex justify-between lg:w-max md:px-0 astro-X3CF2X7U">
                  <a
                    href="#home"
                    aria-label="logo"
                    className="flex space-x-2 items-center astro-X3CF2X7U"
                  >
                    <div
                      aria-hidden="true"
                      className="flex space-x-1 astro-X3CF2X7U"
                    >
                      <div className="h-4 w-4 rounded-full bg-gray-900 dark:bg-white astro-X3CF2X7U" />
                      <div className="h-6 w-2 bg-primary astro-X3CF2X7U" />
                    </div>
                    <span className="text-2xl font-bold text-gray-900 dark:text-white astro-X3CF2X7U">
                      Astrolus
                    </span>
                  </a>
                  <div className="relative flex items-center lg:hidden max-h-10 astro-X3CF2X7U">
                    <label
                      role="button"
                      htmlFor="toggle_nav"
                      aria-label="humburger"
                      id="hamburger"
                      className="relative  p-6 -mr-6 astro-X3CF2X7U"
                    >
                      <div
                        aria-hidden="true"
                        id="line"
                        className="m-auto h-0.5 w-5 rounded bg-sky-900 dark:bg-gray-300 transition duration-300 astro-X3CF2X7U"
                      />
                      <div
                        aria-hidden="true"
                        id="line2"
                        className="m-auto mt-2 h-0.5 w-5 rounded bg-sky-900 dark:bg-gray-300 transition duration-300 astro-X3CF2X7U"
                      />
                    </label>
                  </div>
                </div>
                <div
                  aria-hidden="true"
                  className="fixed z-10 inset-0 h-screen w-screen bg-white/70 backdrop-blur-2xl origin-bottom scale-y-0 transition duration-500 peer-checked:origin-top peer-checked:scale-y-100 lg:hidden dark:bg-gray-900/70 astro-X3CF2X7U"
                />
                <div
                  className="flex-col z-20 flex-wrap gap-6 p-8 rounded-3xl border border-gray-100 bg-white shadow-2xl shadow-gray-600/10 justify-end w-full invisible opacity-0 translate-y-1  absolute top-full left-0 transition-all duration-300 scale-95 origin-top 
                      ...
                      dark:shadow-none dark:bg-gray-800 dark:border-gray-700 astro-X3CF2X7U"
                >
                  <div className="text-gray-600 dark:text-gray-300 lg:pr-4 lg:w-auto w-full lg:pt-0 astro-X3CF2X7U">
                    <ul className="tracking-wide font-medium lg:text-sm flex-col flex lg:flex-row gap-6 lg:gap-0 astro-X3CF2X7U">
                      <li className="astro-X3CF2X7U">
                        <a
                          href="#features"
                          className="block md:px-4 transition hover:text-primary astro-X3CF2X7U"
                        >
                          <span className="astro-X3CF2X7U">Features</span>
                        </a>
                      </li>
                      <li className="astro-X3CF2X7U">
                        <a
                          ...
                          className="block md:px-4 transition hover:text-primary astro-X3CF2X7U"
                        >
                          <span className="astro-X3CF2X7U">Solution</span>
                        </a>
                      </li>
                      <li className="astro-X3CF2X7U">
                        <a
                          ...
                          className="block md:px-4 transition hover:text-primary astro-X3CF2X7U"
                        >
                          <span className="astro-X3CF2X7U">Testimonials</span>
                        </a>
                      </li>
                      <li className="astro-X3CF2X7U">
                        <a
                          ...
                          className="block md:px-4 transition hover:text-primary astro-X3CF2X7U"
                        >
                          <span className="astro-X3CF2X7U">Blog</span>
                        </a>
                      </li>
                    </ul>
                  </div>
                  <div className="mt-12 lg:mt-0 astro-X3CF2X7U">
                    <a
                      href="#"
                      className="relative flex h-9 w-full items-center justify-center px-4 before:absolute before:inset-0 before:rounded-full before:bg-primary before:transition before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95 sm:w-max astro-X3CF2X7U"
                    >
                      <span className="relative text-sm font-semibold text-white astro-X3CF2X7U">
                        Get Started
                      </span>
                    </a>
                  </div>
              ...
              <div className="relative pt-36 ml-auto">
                <div className="lg:w-2/3 text-center mx-auto">
                  ...
                  <p className="mt-8 text-gray-700 dark:text-gray-300">
                    ...
                    Odio incidunt nam itaque sed eius modi error totam sit
                    illum. Voluptas doloribus asperiores quaerat aperiam. Quidem
            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
              <div className="md:w-2/3 lg:w-1/2">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  ...
                  ad ipsum pariatur autem, fugit laborum in atque amet
              ...
              <div className="space-y-6 justify-between text-gray-600 md:flex flex-row-reverse md:gap-6 md:space-y-0 lg:gap-12 lg:items-center">
                ...
                <div className="md:7/12 lg:w-1/2">
                  ...
                  <p className="my-8 text-gray-600 dark:text-gray-300">
                    ...
                    impedit, at reprehenderit aliquam a ipsum quas voluptatem.
